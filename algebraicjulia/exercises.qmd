...
representing steps from one state to another. Given this, the schema for a discrete dynamical system (DDS) is presented by a single object with a single endomorphism.
